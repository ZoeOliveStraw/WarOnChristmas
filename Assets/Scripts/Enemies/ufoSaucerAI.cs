...
public class ufoSaucerAI : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        {
            transform.position = Vector2.MoveTowards(transform.position, new Vector2(-3, player.position.y), moveSpeed * Time.deltaTime);
        }
        else
        {
